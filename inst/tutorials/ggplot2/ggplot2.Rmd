...
```{r passengers, exercise=TRUE, exercise.lines = 5, exercise.setup = "prepare-pass"}
...
```{r pass, exercise=TRUE, exercise.lines = 5, exercise.setup = "prepare-pass"}
...
```{r stock, exercise=TRUE, exercise.lines=4, exercise.setup = "prepare-stock"}
...
```{r stock-ts, exercise=TRUE, exercise.lines=5, exercise.setup = "prepare-stock"}
...
```{r stock-ts-log, exercise=TRUE, exercise.lines=6, exercise.setup = "prepare-stock"}
